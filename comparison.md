...
```markdown
![Deep Learning Confusion Matrix](/Users/anand/Desktop/FAI/Results/cf_deep_learning.png)
```

#### Training & Validation Loss

```markdown
![Training and Validation Loss](/Users/anand/Desktop/FAI/Results/training_validation_loss_curves.png)
```
...
```markdown
![XGBoost Confusion Matrix](/Users/anand/Desktop/FAI/Results/confusion_Xgboost.png)
```

#### Training & Validation Loss

```markdown
![Training and Validation Loss](/Users/anand/Desktop/FAI/Results/training_validation_loss_xgboost.png)
```
